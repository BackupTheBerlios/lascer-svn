...
VAR
  ...
  skz:INTEGER;
  figanz,figcode,farbcode,vspcode,smcode:DATBEREICH;
...
VAR
  ...
  skz:INTEGER;
  figanz,figcode3,farbcode3,figcode4,farbcode4,vspcode,smcode:DATBEREICH;
  stlcode,stlwert:DATBEREICH;
  ddatname:STRING[31];
