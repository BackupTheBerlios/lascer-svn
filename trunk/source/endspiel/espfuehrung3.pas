...
FUNCTION Max(wert1,wert2:INTEGER):INTEGER;
BEGIN
  IF wert1>=wert2 THEN
      Max:=wert1
    ELSE
...
PROCEDURE ZugAusgabe(ausgabezug:ZUG;neustell:STELLUNG;VAR zugausnr:INTEGER);
VAR
  altspos,neuspos:SPOSITION;
  stlart:STELLART;
  stlwert:STWERT;
