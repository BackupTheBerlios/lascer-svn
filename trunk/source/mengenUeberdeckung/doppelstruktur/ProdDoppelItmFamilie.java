/*
 * Dateiname      : ProdDoppelItmFamilie.java
 ...
 * der Kosten verwendet wird. Die Kosten der Familie ergeben sich als Produkt
 ...
 */
public class ProdDoppelItmFamilie extends DoppelItmFamilie implements Cloneable {
     ...
     */
    public ProdDoppelItmFamilie(int groesseGesamtmenge,
     ...
     */
    protected ProdDoppelItmFamilie(ProdDoppelItmFamilie andereFamilie,
    ...
    public ItmFamilie neueInstanz(boolean festeVerwaltung) {
        return (new ProdDoppelItmFamilie(this, festeVerwaltung));
    }
     ...
     */
    public Object clone() {
        return (new ProdDoppelItmFamilie(this));
    }

    /**
     * Liefert die Kosten der enthaltenen Teilmengen. Das ist das Produkt aus
     ...
     * der übergebenen Teilmenge erhöhen. Dies ist die Differenz der Produkte
     * aus den allgemeinen Kosten der Teilmenge und den Kosten der
     * Kosten-Indices, die von der Teilmenge überdeckt werden.
     *
     * @param teilmenge  Die Teilmenge, für die die Kosten durch Hinzufügen
     *                   zur Familie ermittelt werden sollen.
     *
    ...
    public float kostenHinzufuegen(IndexTeilmenge teilmenge) {
        ...
        kostenEinfach = kostenFamilieEinfach();
        kostenAlt = kostenEinfach * indexKostenGesamt();
        kostenNeu = ((kostenEinfach + kostenHinzufuegenEinfach(teilmenge))
                     * (indexKostenGesamt() + itmIndexKosten));

        return (kostenNeu - kostenAlt);
    }

    /**
     * Liefert den Wert, um den sich die Kosten der Familie durch Entfernen
     * der übergebenen Teilmenge verringern. Dies ist die Differenz der
     * Produkte aus den allgemeinen Kosten der Teilmenge und den Kosten der
     * Kosten-Indices, die von der Teilmenge überdeckt werden.
     *
    ...
    public float kostenEntfernen(IndexTeilmenge teilmenge) {
        ...
        kostenEinfach = kostenFamilieEinfach();
        kostenAlt = kostenEinfach * indexKostenGesamt();
        kostenNeu = ((kostenEinfach - kostenEntfernenEinfach(teilmenge))
                     * (indexKostenGesamt() - itmIndexKosten));

        return (kostenAlt - kostenNeu);
    }
    ...
    public static void main(String[] args) {
        ProdDoppelItmFamilie doppelItmFamilie;
        ...
        indexKostenFunktionen = new FixedExistentCosts(testIndexKosten,
                                                       groesseGesamtmenge);
        doppelItmFamilie = new ProdDoppelItmFamilie(groesseGesamtmenge,
