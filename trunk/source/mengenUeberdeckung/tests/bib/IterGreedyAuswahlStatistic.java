 ...
 * zur Mengenüberdeckung zu einem Verzeichnis mit Problemdateien, wobei die
 ...
 * dem Namen der Ausgabedatei auf der Komandozeile übergeben. Außerdem ist ein
 * Faktor anzugeben, der die Größe der Auswahl bestimmt.
 *
...
public class IterGreedyAuswahlStatistic {
     ...
     * und dann das Iterated-Greedy-Verfahren zur Mengenüberdeckung darauf
     * anwendet.
     *
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 5) {
            System.err.println("Keine fünf Parameter angegeben");
            System.exit(-1);
        }
