/*
 * Dateiname      : AbstEinStellIntFunk.java
...
/**
 * Abstrakte einstellige int-Funktion.
 *
 * @author  Dietmar Lippold
 */
public abstract class AbstEinStellIntFunk implements EinStellIntFunk {

    /**
     * Die Argumentfunktion dieser Funktion.
     */
    private ErzeugbareIntFunk argFunktion;
     ...
     */
    public AbstEinStellIntFunk(int nummer, ErzeugbareIntFunk argFunktion) {
        this.nummer = nummer;
     ...
     */
    public ErzeugbareIntFunk argumentFunktion() {
        return argFunktion;
    }
     ...
     *          Argumentfunktion.
     */
    protected abstract int funkWert(int funkWert);
     ...
     */
    protected abstract int[] funkWerte(int[] argFunkWerte);
     ...
     */
    private void korrekturUnbekWerte(int[] ergebnisWerte, int[] argWerte) {
