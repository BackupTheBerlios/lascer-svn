/*
 * Dateiname      : RealMultiplikation.java
...
/**
 * Eine Funktion, die ein Produkt berechnet.
 *
 * @author  Dietmar Lippold
 */
public class RealMultiplikation extends AbstZweiStellRealFunk {

    /**
     * Erzeugt eine neue Instanz, die das Produkt der Funktionswerte der
     * beiden Argumentfunktionen berechnet.
     *
     ...
     */
    public RealMultiplikation(int nummer, ErzeugbareRealFunk argFunktion1,
    ...
    protected float eigeneKomplexitaet() {
        return Konstanten.KOMPLEX_MULTIPLIKATION;
    }
