/*
 * Dateiname      : KonkretAlgKorrTest2.java
...
/**
 * Stellt einen Test mit konkreten allgemeinen und vollständigen Teilmengen
 * zur Erzeugung eines korrekten und vollständigen Konzepts dar.
 *
 * @author  Dietmar Lippold
 */
public class KonkretAlgKorrTest2 {
    ...
    public static void main(String[] args) {
        ...
        posBspWerte2 = new boolean[] {true, true, false, false};
        posBspWerte3 = new boolean[] {true, true, true, true};
        posBspWerte4 = new boolean[] {true, true, false, true};

        negBspWerte1 = new boolean[] {true, false, true, true};
        negBspWerte2 = new boolean[] {false, false, false, true};
        negBspWerte3 = new boolean[] {true, false, false, false};
        negBspWerte4 = new boolean[] {true, false, true, false};
