/*
 * Dateiname      : AlleIntIntervallErzeug.java
 ...
 * Werten zur Verfügung. Die Erzeugung erfolgt unter der Voraussetzung, daß
 * die Komplexität eines Einzelwert-Intervall-Prädikats kleiner oder gleich
 * ist wie die eines Halb-Intervall-Prädikats und diese wiederum kleiner oder
 * gleich ist wie die eines Voll-Intervall-Prädikats.
 *
 * @author  Dietmar Lippold
 */
public class AlleIntIntervallErzeug implements IntIntervallErzeugung {
    ...
    public LinkedList vollstaendigeIntervalle(int[] inklusivWerte,
        ...
        if (inklWertAnz == 0) {
            ...
            if (minInklWert == maxInklWert) {
                ...
                intervalle.add(new IntIntervall(minInklWert, minInklWert));
            } else {
            ...
            if ((minExklWert < minInklWert) || (maxInklWert < maxExklWert)) {
                if (minInklWert == maxInklWert) {
                    ...
                    intervalle.add(new IntIntervall(Konstanten.MIN_WERT, maxInklWert));
                    intervalle.add(new IntIntervall(minInklWert, Konstanten.MAX_WERT));
                    intervalle.add(new IntIntervall(minInklWert, maxInklWert));
                }
            }
            return intervalle;
        }
     ...
     */
    private LinkedList korrEwIntervalle(int[] werte,
        ...
        while (index <= maxIndex) {
            wert = werte[index];
            intervalle.add(new IntIntervall(wert, wert));
            do {
                index++;
    ...
    public LinkedList korrekteIntervalle(int[] inklusivWerte,
        ...
        if (inklWertAnz == 0) {
            ...
            maxInklWert = inklusivWerte[inklWertAnz - 1];
            if (minInklWert == maxInklWert) {
                intervalle.add(new IntIntervall(maxInklWert, maxInklWert));
            } else {
                intervalle.add(new IntIntervall(Konstanten.MIN_WERT, maxInklWert));
                intervalle.add(new IntIntervall(minInklWert, Konstanten.MAX_WERT));
        ...
        if (inklusivWerte[inklIndex] < exklWert) {
            if (inklusivWerte[inklIndex] == inklusivWerte[0]) {
                ...
                intervalle.add(new IntIntervall(inklusivWerte[0],
                                                inklusivWerte[0]));
            } else {
            ...
            if (inklWert != exklWert) {
                ...
                if (exklWert < inklWert) {
                    ...
                    if (inklusivWerte[unterIndex] == inklusivWerte[inklIndex]) {
                        ...
                        // Das Intervall besteht aus mehreren Werten.
                        intervalle.add(new IntIntervall(inklusivWerte[unterIndex],
                                                        Konstanten.MAX_WERT));
                        intervalle.addAll(korrEwIntervalle(inklusivWerte,
                                                           unterIndex, inklIndex));
                    }
     ...
     * @return  Eine Liste mit den erzeugten Einzelwert-Intervallen.
     */
    private LinkedList algEwIntervalle(int[] inklusivWerte,
                                       int[] exklusivWerte) {
        LinkedList intervalle;
        int        inklWert;
        int        inklWertAnz, exklWertAnz;
        ...
        while (inklIndex < inklWertAnz) {
            ...
            if (inklWert == exklusivWerte[exklIndex]) {
                intervalle.add(new IntIntervall(inklWert, inklWert));
            }
    ...
    public LinkedList allgemeineIntervalle(int[] inklusivWerte,
                                           int[] exklusivWerte) {
        LinkedList intervalle;
        int inklUnterWert, exklUnterWert;
        int inklOberWert, exklOberWert;
        int inklWertAnz, exklWertAnz;
            ...
            while (inklOberIndex + 1 < inklWertAnz) {
                ...
                if ((inklUnterWert > inklusivWerte[0])
                    ...
                    if (inklOberWert != inklUnterWert) {
                        intervalle.add(new IntIntervall(inklUnterWert,
                                                        inklOberWert));
                    }
                }
            }
    ...
    public static void main(String[] args) {
        IntIntervallErzeugung intErz     = new AlleIntIntervallErzeug();
        int[]                 inklWerte;
        int[]                 exklWerte;
