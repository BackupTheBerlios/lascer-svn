/*
 * Dateiname      : RealRealBgPraedikat.java
 ...
 * überprüft, ob der einer Werte den anderen Wert beschränkt oder gleich zu
 * diesem ist, also kleiner-gleich oder größer-gleich ist.
 *
 * @author  Dietmar Lippold
 */
public class RealRealBgPraedikat extends RealRealPraedikat {
     ...
     *                       größer-gleich Vergleich durchgeführt.
     */
    public RealRealBgPraedikat(RealAttribut attribut1, RealAttribut attribut2,
    ...
    public float komplexitaet() {
        return Konstanten.REAL_REAL_BG_PRAED_KOMPLEX;
    }
