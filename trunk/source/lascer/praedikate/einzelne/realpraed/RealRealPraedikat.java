/*
 * Dateiname      : RealRealPraedikat.java
...
/**
 * Definiert ein Prädikat, das die Fließkomma-Werte zweier Attribute
 * miteinander vergleicht.
 *
 * @author  Dietmar Lippold
 */
public abstract class RealRealPraedikat implements Praedikat {

    /**
     * Das erste Attribut, dessen Wert verglichen wird.
     */
    private RealAttribut testAttribut1;

    /**
     * Das zweite Attribut, dessen Wert verglichen wird.
     */
    private RealAttribut testAttribut2;
     ...
     *                   soll.
     */
    public RealRealPraedikat(RealAttribut attribut1, RealAttribut attribut2) {
     ...
     *          erfüllt ist.
     */
    protected abstract boolean erfuellt(float wert1, float wert2);
    ...
    public boolean wert(Beispiel beispiel, boolean invertiert) {
        ...
        wert1 = beispiel.getRealWert(testAttribut1);
        wert2 = beispiel.getRealWert(testAttribut2);
     ...
     *          invertiert.
     */
    private boolean[] praedikatWerte(float[] attribWerte1, float[] attribWerte2,
    ...
    public boolean[] posBspWerte(Beispieldaten beispieldaten, boolean invertiert) {
        ...
        attribWerte1 = beispieldaten.getRealWerte(testAttribut1, true);
        attribWerte2 = beispieldaten.getRealWerte(testAttribut2, true);
    ...
    public boolean[] negBspWerte(Beispieldaten beispieldaten, boolean invertiert) {
        ...
        attribWerte1 = beispieldaten.getRealWerte(testAttribut1, false);
        attribWerte2 = beispieldaten.getRealWerte(testAttribut2, false);
