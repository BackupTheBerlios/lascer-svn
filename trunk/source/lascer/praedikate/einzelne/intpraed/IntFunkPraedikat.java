/*
 * Dateiname      : IntFunkPraedikat.java
...
/**
 * Definiert ein abstraktes Prädikat, das die ganzzahligen Werte einer
 * Funktion gegen vorgegebene Werte vergleicht.
 *
 * @author  Dietmar Lippold
 */
public abstract class IntFunkPraedikat implements Praedikat {
     ...
     */
    public IntFunkPraedikat(IntFunktion funktion, Beispieldaten beispieldaten,
                            int[] posBspFunkWerte, int[] negBspFunkWerte,
     ...
     */
    protected IntFunktion funktion() {
        return funktion;
    }
     ...
     */
    protected abstract boolean[] bspWerte(int[] funkWerte);
     ...
     *          invertiert.
     */
    private boolean[] praedikatWerte(int[] funkWerte, boolean invertiert,
