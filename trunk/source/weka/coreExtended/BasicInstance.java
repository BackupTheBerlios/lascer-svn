...
/** 
 * Class for handling a basic instance.
 *
 * @author  Yang Zhou
 *
 * @version  8. Jul. 2002
...
public class BasicInstance extends Instance {
 ...
 /**
   ...
   */
  public BasicInstance(BasicInstance instance) {
   ...
   */
  public BasicInstance(double weight, double[] attValues){
   ...
   */
  public BasicInstance(int numAttributes) {
   ...
   * dataset
   */ 
  public BasicAttribute attribute(int index) {
   
    if (m_Dataset == null) {
      throw new UnassignedDatasetException("Instance doesn't have access to a dataset!");
    }
    return m_Dataset.basicAttribute(index);
  }
   ...
   * dataset
   */ 
  public BasicAttribute attributeSparse(int indexOfIndex) {
   
    if (m_Dataset == null) {
      throw new UnassignedDatasetException("Instance doesn't have access to a dataset!");
    }
    return m_Dataset.basicAttribute(indexOfIndex);
  }
 ...
 /** Returns the class attribute's index.
  ...
  public int classIndex() {
    ...
    return m_Dataset.basicClassIndex();
  }
...
/**
   ...
   */
  public BasicAttribute classAttribute() {

    if (m_Dataset == null) {
      throw new UnassignedDatasetException("Instance doesn't have access to a dataset!");
    }
    return m_Dataset.basicClassAttribute();
  }
  /**
   ...
   */
   public Object copy() {
    ...
    BasicInstance result = new BasicInstance(this);
  ...
  public final String toString(int attIndex) {
   ...
   if (isMissing(attIndex)) {
     ...
     if (m_Dataset == null) {
       ...
       if (m_Dataset.basicAttribute(attIndex).isNominal() || 
	   m_Dataset.basicAttribute(attIndex).isString()) {
  ...
  public final String stringValue(int attIndex) {
    ...
    return m_Dataset.basicAttribute(attIndex).
  ...
  public BasicInstance mergeInstance(Instance inst) {
    ...
    return new BasicInstance(1.0, newVals);
  }
  ...
  public Enumeration enumerateAttributes() {
    ...
    return m_Dataset.enumerateBasicAttributes();
  }
  
  
  /**
   * Tests if the headers of two basic instances are equivalent.
   *
  ...
  public boolean equalHeaders(Instance inst) {
    ...
    return m_Dataset.basicEqualHeaders(inst.m_Dataset);
  }
  ...
  public int numClasses() {
    ...
    return m_Dataset.numBasicClasses();
  }
  ...
  public static void main(String[] options) {
    ...
    try {
      ...
      BasicAttribute length = new BasicAttribute("length",false);
      BasicAttribute weight = new BasicAttribute("weight",true);
      ...
      // Create nominal BasicAttribute "position" 
      BasicAttribute position = new BasicAttribute("position", my_nominal_values);
      
      // Create vector of the above BasicAttributes 
      ...
      Instances race = new Instances("race", attributes, 0,0);
      
      // Make position the class BasicAttribute
      race.setBasicClassIndex(position.index());
      
      // Create empty instance with three BasicAttribute values
      BasicInstance inst = new BasicInstance(3);
      
      // Set instance's values for the BasicAttributes "length", "weight", and "position"
      ...
      // Print the first BasicAttribute
      System.out.println("First BasicAttribute: " + inst.attribute(0));
      
      // Print the class BasicAttribute
      System.out.println("Class BasicAttribute: " + inst.classAttribute());
      ...
      copy.setDataset(inst.dataset());
      System.out.println("Copy with first BasicAttribute deleted and inserted: " + copy); 
      
      // Enumerate attributes (leaving out the class attribute)
      System.out.println("Enumerating attributes (leaving out class):");
      Enumeration enum = inst.enumerateAttributes();
      while (enum.hasMoreElements()) {
	BasicAttribute att = (BasicAttribute) enum.nextElement();
	System.out.println(att);
      ...
      System.out.println("Number of BasicAttributes: " + copy.numAttributes());
      ...
      copy.setMissing(1);
      System.out.println("Copy with second BasicAttribute set to be missing: " + copy);
      copy.setMissing(length);
      System.out.println("Copy with length set to be missing: " + copy);
      copy.setValue(0, 0);
      System.out.println("Copy with first BasicAttribute set to 0: " + copy);
      copy.setValue(weight, 1);
      System.out.println("Copy with weight BasicAttribute set to 1: " + copy);
      copy.setValue(position, "second");
      System.out.println("Copy with position set to \"second\": " + copy);
      copy.setValue(2, "first");
      System.out.println("Copy with last BasicAttribute set to \"first\": " + copy);
