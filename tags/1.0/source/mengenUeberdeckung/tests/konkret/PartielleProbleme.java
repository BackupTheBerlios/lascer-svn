/*
 * Dateiname      : PartielleProbleme.java
...
/**
 * Die Klasse enthält eine Reihe von konkreten partiellen
 * Überdeckungsproblemen.
 *
 * @author  Dietmar Lippold
 */
public class PartielleProbleme {
    ...
    static {
        ...
        teilmenge = new IndexTeilmenge(8, 1);
        teilmenge.indicesAufnehmen(new int[] {1, 2, 3});
        problem.teilmengeHinzufuegen(teilmenge);

        teilmenge = new IndexTeilmenge(8, 2);
        teilmenge.indicesAufnehmen(new int[] {3, 4});
        problem.teilmengeHinzufuegen(teilmenge);

        teilmenge = new IndexTeilmenge(8, 4);
        teilmenge.indicesAufnehmen(new int[] {2, 5});
        problem.teilmengeHinzufuegen(teilmenge);

        teilmenge = new IndexTeilmenge(8, 5);
        teilmenge.indicesAufnehmen(new int[] {1, 6});
        problem.teilmengeHinzufuegen(teilmenge);
