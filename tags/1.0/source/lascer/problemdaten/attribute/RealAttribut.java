...
/**
 * Implementiert ein nicht-ganzzahliges Attribut.
 *
 * @author  Dietmar Lippold
 */
public class RealAttribut extends AbstraktesAttribut {
     ...
     */
    public RealAttribut(String name) {
        super(name);
    }
