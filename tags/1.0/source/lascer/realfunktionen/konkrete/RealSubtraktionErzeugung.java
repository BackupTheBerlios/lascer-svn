/*
 * Dateiname      : RealSubtraktionErzeugung.java
...
/**
 * Erzeugt eine Funktion, die eine Differenz berechnet.
 *
 * @author  Dietmar Lippold
 */
public class RealSubtraktionErzeugung implements ZweiStellRealFunkErz {

    /**
     * Erzeugt eine zweistellige Funktion zur Berechnung der Differenz der
     ...
     *                      Funktion.
     *
     * @return  Die erzeugte zweistellige Funktion zur Berechnung der
    ...
    public ZweiStellRealFunk zweiStelligeFunktion(int nummer,
        ...
        return new RealSubtraktion(nummer, argFunktion1, argFunktion2);
    }
}
