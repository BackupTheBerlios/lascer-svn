/*
 * Dateiname      : RealAbsSubstErzeugung.java
...
/**
 * Erzeugt eine Funktion, die den Absolutwert einer Differenz berechnet.
 *
 * @author  Dietmar Lippold
 */
public class RealAbsSubstErzeugung implements ZweiStellRealFunkErz {

    /**
     * Erzeugt eine zweistellige Funktion zur Berechnung des Absolutwerts der
     * Differenz der Funktionswerte der beiden Argumentfunktionen.
     *
     ...
     *                      Funktion.
     *
     * @return  Die erzeugte zweistellige Funktion zur Berechnung des
     *          Absolutwerts der Differenz der Funktionswerte der beiden
     *          Argumentfunktionen.
     */
    public ZweiStellRealFunk zweiStelligeFunktion(int nummer,
                                                  ErzeugbareRealFunk argFunktion1,
                                                  ErzeugbareRealFunk argFunktion2) {
        return new RealAbsSubst(nummer, argFunktion1, argFunktion2);
    }
}
