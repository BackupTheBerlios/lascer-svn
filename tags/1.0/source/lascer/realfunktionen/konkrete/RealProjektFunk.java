/*
 * Dateiname      : RealProjektFunk.java
...
/**
 * Eine Funktion, die ein Beispiel auf den Wert eines real-Attributs abbildet.
 *
 * @author  Dietmar Lippold
 */
public class RealProjektFunk implements ErzeugbareRealFunk, Serializable {

    /**
     * Das Attribut, dessen Wert für ein Beispiel die Funktion liefern soll.
     */
    private RealAttribut attribut;
     ...
     */
    public RealProjektFunk(int nummer, RealAttribut attribut) {
        this.nummer = nummer;
    ...
    public float wert(Beispiel beispiel) {
        return beispiel.getRealWert(attribut);
    }
    ...
    public float[] posBspWerte(Beispieldaten beispieldaten) {
        return beispieldaten.getRealWerte(attribut, true);
    }
    ...
    public float[] negBspWerte(Beispieldaten beispieldaten) {
        return beispieldaten.getRealWerte(attribut, false);
    }
