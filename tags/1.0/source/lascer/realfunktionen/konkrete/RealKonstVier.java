...
/**
 * Eine Funktion, die den konstanten Wert Vier liefert.
 *
 * @author  Dietmar Lippold
 */
public class RealKonstVier extends AbstNullStellRealFunk {

    /**
     * Erzeugt eine neue Instanz, die die Konstante Vier als Wert liefert.
     *
     * @param nummer  Die Nummer dieser Funktion.
     */
    public RealKonstVier(int nummer) {
        super(nummer);
    }
