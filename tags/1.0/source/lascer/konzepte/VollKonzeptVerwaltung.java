...
/**
 * Verwaltet eine Menge von vollständigen Konzepte und steuert deren
...
public class VollKonzeptVerwaltung implements KonzeptVerwaltung, Serializable {
    ...
    /**
     * Die Menge der aufgenommenden vollständigen Konzepte.
     */
    ...
    /**
     * Nimmt das übergebene Prädikat in die passenden Konzeptmengen auf.
     * Wenn es ein allgemeines Konzept darstellt und die Mengen für die
     * allgemeinen Konzepte wurden noch nicht erzeugt, wird das Prädikat nicht
     * aufgenommen.
     *
     ...
     * Menge der vollständigen Konzepte auf. Wenn es ein allgemeines Konzept
     * darstellt, wird das Konzept nicht aufgenommen.<P>
     *
     * Die Bedingungen stellen sicher, daß das Konzept ein vollständiges
     * Konzept einer Formel ersetzen kann. Die Fehler der um das vollständige
     * Konzept reduzierten Formel werden dazu übergeben.
     *
     * @param konzept           Das aufzunehmende Konzept.
     * @param redKonzPosFehler  Die Fehler der positiven Beispiele der Formel,
     *                          die durch die Entfernung des vollständigen
     ...
     * Konzept ein vollständiges Konzept einer Formel ersetzen kann. Die
     * Fehler der um das vollständiges Konzept reduzierten Formel werden dazu
     * übergeben.
     *
     * @param praedikat         Das aufzunehmende Prädikat.
     ...
     * vollständiges Konzepts ersetzen kann. Die Fehler des um das Teilkonzept
     * reduzierten vollständigen Konzepts werden zusammen mit der Komplexität
     * und der Anzahl der Fehler des Teilkonzepts übergeben.
     *
     * @param konzept           Das aufzunehmende Konzept.
     * @param redKonzPosFehler  Die Fehler der positiven Beispiele des
     *                          vollständigen Konzepts, aus dem das
     ...
     *
     * Die Bedingungen stellen sicher, daß das aus dem Prädikat erzeugte
     * Konzept ein Teilkonzept eines vollständigen Konzepts ersetzen kann. Die
     * Fehler des um das Teilkonzept reduzierten vollständigen Konzepts werden
     ...
     * Bezug auf den aktuellen Inhalt der Menge der vollständigen Konzepte.
     * Wenn die Menge der allgemeiner Konzepte schon vorhanden ist, können
     * deren Konzepte in die neu erzeugte Menge übernommen werden.
     *
    ...
    /**
     * Liefert ein vollständigen Konzept, das aus der Menge der allgemeinen
     * Konzepte erzeugt wurde. Dies geschieht mit Bezug auf den aktuellen
     * Inhalt der Menge der vollständigen Konzepte, wobei aber einige der
     ...
     *                          zurück geliefert.
     *
     * @return  Das erzeugte vollständige Konzept oder den Wert
     ...
     * Liefert ein vollständigen Konzept, das aus der Menge der allgemeinen
     * Konzepte erzeugt wurde. Dies geschieht mit Bezug auf den aktuellen
     * Inhalt der Menge der vollständigen Konzepte. Wenn die Menge der
    ...
    /**
     * Liefert ein vollständiges Konzept, das aus der Menge der allgemeinen
     * Konzepte erzeugt wurde. Dies geschieht mit Bezug auf den aktuellen
     * Inhalt der Menge der vollständigen Konzepte, wobei aber einige der
     * bisher nicht ausgeschlossenen Beispiele ausgeschlossen behandelt
     * werden. Wenn die Menge der allgemeinen Konzepte noch nicht erzeugt
    ...
    /**
     * Liefert eine Menge von vollständigen Konzepten, die aus der Menge der
     * allgemeinen Konzepte erzeugt wurden. Dies geschieht mit Bezug auf den
     * aktuellen Inhalt der Menge der vollständigen Konzepte. Wenn die Menge
     * der allgemeinen Konzepte noch nicht erzeugt wurden, wird eine leere
     * Menge geliefert.
     *
     * @param scpIterAnz  Die Anzahl der Iterationen im SCP-Verfahren.
     *
     * @return  Die Menge der erzeugten vollständigen Konzepte vom Typ
    ...
    /**
     * Gibt an, ob mit Sicherheit alle hinzugefügten vollständigen Konzepte in
     * der Auswahl enthalten sind.
     *
     * @return  Die Angabe, ob mit Sicherheit alle hinzugefügten vollständigen
    ...
    /**
     * Liefert die Anzahl der enthaltenen vollständigen Konzepte.
     *
     * @return  Die Anzahl der enthaltenen vollständigen Konzepte.
     */
    ...
    /**
     * Liefert die Menge der enthaltenen vollständigen Konzepte.
     *
     * @return  Die Menge der enthaltenen vollständigen Konzepte.
     */
     ...
     * Indices multipliziert wird, um die Kosten für einen nicht
     ...
     *
     * @param scpIterAnz      Die Anzahl der Iterationen im SCP-Verfahren.
     * @param bekannteFormel  Eine bekannte vollständige Formel oder der Wert
