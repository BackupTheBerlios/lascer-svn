/*
 * Dateiname      : AbstZweiStellIntFunk.java
 ...
 */
public abstract class AbstZweiStellIntFunk implements ZweiStellIntFunk {

    /**
     * Die erste Argumentfunktion dieser Funktion.
     */
    private ErzeugbareIntFunk argFunktion1;

    /**
     * Die zweite Argumentfunktion dieser Funktion.
     */
    private ErzeugbareIntFunk argFunktion2;
     ...
     *                      Funktion.
     */
    public AbstZweiStellIntFunk(int nummer, ErzeugbareIntFunk argFunktion1,
     ...
     *          Argumentfunktionen.
     */
    protected abstract int funkWert(int funkWert1, int funkWert2);
     ...
     */
    protected abstract int[] funkWerte(int[] funkWerte1, int[] funkWerte2);
     ...
     */
    private void korrekturUnbekWerte(int[] ergebnisWerte,
                                     int[] argWerte1, int[] argWerte2) {
