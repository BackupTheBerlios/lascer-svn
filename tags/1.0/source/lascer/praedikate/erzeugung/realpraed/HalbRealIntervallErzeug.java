/*
 * Dateiname      : HalbRealIntervallErzeug.java
 ...
 * Fließkomma-Werten zur Verfügung, wobei nur Halb-Intervalle erzeugt werden.
 *
 * @author  Dietmar Lippold
 */
public class HalbRealIntervallErzeug implements RealIntervallErzeugung {
     ...
     *          vom Typ <CODE>RealIntervall</CODE> oder eine leere Liste, wenn
    ...
    public static void main(String[] args) {
        RealIntervallErzeugung intErz     = new HalbRealIntervallErzeug();
        float[]                inklWerte;
        float[]                exklWerte;
