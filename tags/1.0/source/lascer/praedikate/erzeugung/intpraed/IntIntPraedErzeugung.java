/*
 * Dateiname      : IntIntPraedErzeugung.java
...
import lascer.praedikate.einzelne.intpraed.IntIntPraedikat;
import lascer.praedikate.einzelne.intpraed.IntIntGlPraedikat;
import lascer.praedikate.einzelne.intpraed.IntIntBgPraedikat;
import lascer.praedikate.einzelne.intpraed.IntIntBuPraedikat;
 ...
 * zweier ganzzahliger Attribute.
 *
 * @author  Dietmar Lippold
 */
public class IntIntPraedErzeugung implements PraedikatErzeugung {
     ...
     *                       werden sollen.
     */
    public IntIntPraedErzeugung(Beispieldaten beispieldaten) {
        AttributSammlung attributSammlung;
        IntAttribut      attribut1, attribut2;
        IntIntPraedikat  neuesPraed;
        int[]            posBspWerte1, posBspWerte2;
        int[]            negBspWerte1, negBspWerte2;
        int              attribAnz;
        ...
        for (int a1Nr = 0; a1Nr < attribAnz - 1; a1Nr++) {
            attribut1 = attributSammlung.getIntAttribut(a1Nr);
            for (int a2Nr = a1Nr + 1; a2Nr < attribAnz; a2Nr++) {
                attribut2 = attributSammlung.getIntAttribut(a2Nr);
                ...
                // Attribute gibt.
                posBspNr = 0;
                posBspWerte1 = beispieldaten.getIntWerte(attribut1, true);
                posBspWerte2 = beispieldaten.getIntWerte(attribut2, true);
                ...
                // Attribute gibt.
                negBspNr = 0;
                negBspWerte1 = beispieldaten.getIntWerte(attribut1, false);
                negBspWerte2 = beispieldaten.getIntWerte(attribut2, false);
                ...
                neuesPraed = new IntIntGlPraedikat(attribut1, attribut2);
                ...
                if (posGleich) {
                    ...
                    neuesPraed = new IntIntBgPraedikat(attribut1, attribut2,
                                                       true);
                ...
                neuesPraed = new IntIntBuPraedikat(attribut1, attribut2, true);
                ...
                neuesPraed = new IntIntBuPraedikat(attribut1, attribut2, false);
