...
public class Konstanten {
     ...
     * int-Attribute mit einem Wert an.
     */
    public static final float INT_WERT_PRAED_KOMPLEX = 2.0f;

    /**
     * Gibt die Komplexität eines Prädikats für den Vergleich zweier
     * int-Attribute in Bezug auf Gleichheit an.
     */
    public static final float INT_INT_GL_PRAED_KOMPLEX = 2.5f;

    /**
     * Gibt die Komplexität eines Prädikats für den Vergleich zweier
     * int-Attribute in Bezug auf die Beschränkung des einen Attributs durch
     * das andere Attribut oder deren Gleichheit an.
     */
    public static final float INT_INT_BG_PRAED_KOMPLEX = 2.5f;

    /**
     * Gibt die Komplexität eines Prädikats für den Vergleich zweier
     * int-Attribute in Bezug auf die Beschränkung des einen Attributs durch
     * das andere Attribut bei Ungleichheit an.
     */
    public static final float INT_INT_BU_PRAED_KOMPLEX = 2.5f;

    /**
     * Gibt die grundlegende Komplexität eines Prädikats zu einer Funktion für
     * int-Attribute an, bei dem geprüft wird, ob der Funktionswert gleich
     ...
     */
    public static final float INT_FUNK_WERT_PRAED_KOMPLEX = 1.0f;

    /**
     * Gibt die grundlegende Komplexität eines Prädikats zu einer Funktion für
     * int-Attribute an, bei dem geprüft wird, ob der Funktionswert in einem
     * gegebenen Halb-Intervall liegt. Bei der tatsächlichen Komplexität eines
     * Prädikats kommt noch die Komplexität der jeweiligen Funktion hinzu.
     */
    public static final float INT_FUNK_HALB_ITV_PRAED_KOMPLEX = 1.5f;
     ...
     * Prädikats kommt noch die Komplexität der jeweiligen Funktion hinzu.
     */
    public static final float INT_FUNK_VOLL_ITV_PRAED_KOMPLEX = 3.0f;
