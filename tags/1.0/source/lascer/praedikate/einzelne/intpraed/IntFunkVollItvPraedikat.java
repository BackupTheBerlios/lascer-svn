/*
 * Dateiname      : IntFunkVollItvPraedikat.java
 ...
 */
public class IntFunkVollItvPraedikat extends IntFunkPraedikat
     ...
     *                         Beispiele.
     */
    public IntFunkVollItvPraedikat(IntFunktion funktion, int minWert,
                                   int maxWert, Beispieldaten beispieldaten,
                                   int[] posBspFunkWerte, int[] negBspFunkWerte) {
        super(funktion, beispieldaten, posBspFunkWerte, negBspFunkWerte,
              Konstanten.INT_FUNK_VOLL_ITV_PRAED_KOMPLEX);
