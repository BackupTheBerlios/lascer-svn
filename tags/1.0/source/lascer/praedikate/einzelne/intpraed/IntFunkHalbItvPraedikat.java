/*
 * Dateiname      : IntFunkHalbItvPraedikat.java
...
/**
 * Definiert ein Prädikat, das für die ganzzahligen Werte einer Funktion
 * prüft, ob sie in einem Halb-Intervall liegen, also kleiner-gleich oder
 * größer-gleich sind zu einem vorgegebenen Wert sind.
 *
 * @author  Dietmar Lippold
 */
public class IntFunkHalbItvPraedikat extends IntFunkPraedikat implements Praedikat {
     ...
     *                         Beispiele.
     */
    public IntFunkHalbItvPraedikat(IntFunktion funktion, int grenzWert,
        ...
        super(funktion, beispieldaten, posBspFunkWerte, negBspFunkWerte,
              Konstanten.INT_FUNK_HALB_ITV_PRAED_KOMPLEX);
     ...
     *          Prädikats.
     */
    protected boolean[] bspWerte(int[] funkWerte) {
        boolean[] bspWerte;
