/*
 * Dateiname      : IntIntGlPraedikat.java
...
/**
 * Definiert ein Prädikat, das die ganzzahligen Werte zweier Attribute mit der
 * Gleichheits-Relation miteinander vergleicht.
 *
 * @author  Dietmar Lippold
 */
public class IntIntGlPraedikat extends IntIntPraedikat {
     ...
     *                   soll.
     */
    public IntIntGlPraedikat(IntAttribut attribut1, IntAttribut attribut2) {
    ...
    public float komplexitaet() {
        return Konstanten.INT_INT_GL_PRAED_KOMPLEX;
    }
