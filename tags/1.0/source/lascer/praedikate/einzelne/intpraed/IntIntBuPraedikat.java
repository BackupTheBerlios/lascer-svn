/*
 * Dateiname      : IntIntBuPraedikat.java
 ...
 * daraufhin überprüft, ob der einer Werte den anderen Wert beschränkt und
 * ungleich ist, also kleiner oder größer ist.
 *
 * @author  Dietmar Lippold
 */
public class IntIntBuPraedikat extends IntIntPraedikat {
     ...
     *                   durchgeführt.
     */
    public IntIntBuPraedikat(IntAttribut attribut1, IntAttribut attribut2,
                             boolean kleiner) {
    ...
    public float komplexitaet() {
        return Konstanten.INT_INT_BU_PRAED_KOMPLEX;
    }
