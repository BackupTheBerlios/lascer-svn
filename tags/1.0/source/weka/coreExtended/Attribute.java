 ...
 * @author Yang Zhou
 *
 * @version $Revision: 1.19.2.3, 08.Jul.2002 $
 */
public abstract class Attribute implements Copyable, Serializable {

  /**Constant set for numeric attributes. */
  public final static int NUMERIC = 0; 
  
  /** Constant set for real attribues. */
  public final static int REAL = 3;
  
  /** Constant set for integer attribues. */
   ...
   *
   * @param attributeName the name for the attribute
   * @param isInt the typ for the attribute
   */
  public Attribute(String attributeName ,boolean isInt) {
 ...
 public abstract Object copy() ;
  ...
  /**
   * Tests if the attribute is real.
   *
   * @return true if the attribute is real
   */
  public final boolean isReal() {
   ...
   /**
   * Tests if the attribute is integer.
   *
   * @return true if the attribute is integer
   */
   ...
   */
  Attribute(String attributeName, boolean isInt,int index) {

    this(attributeName,isInt);
 ...
 abstract  Attribute copy(String newName);
