 ...
 * @author Yang Zhou
 *
 * @version $Revision: 1.13, 08.Jul.2002 $
 */
public abstract class Instance implements Copyable, Serializable {
   ...
   */
  abstract public int classIndex() ;
   ...
   * have access to a dataset 
   */
  abstract public double classValue() ;
   ...
   * have access to a dataset 
   */
  public abstract Enumeration enumerateAttributes() ;
   ...
   * dataset
   */
  public abstract boolean equalHeaders(Instance inst) ;
   ...
   */
 // public abstract Instance mergeInstance(Instance inst) ;
   ...
   * have access to a dataset
   */
  abstract public void setClassMissing() ;
   ...
   * have access to a dataset 
   */
  abstract public void setClassValue(double value) ;
   ...
   * attribute 
   */
  abstract public void setClassValue(String value) ;
   ...
   */
  public abstract String toString(int attIndex) ;
   ...
   * @return the value's description as a string
   */
  public abstract  String toString(Attribute att) ;
